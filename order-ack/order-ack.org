...
#+BEGIN_SRC plantuml :file ../images/order-ack-sequence.puml.png :exports results
  @startuml order-ack-sequence.png
  Buyer -> Seller: [ POST ] order
  Seller -> Buyer: order-ack<U+0394> | error
  @enduml
#+END_SRC
...
**** JSON
#+BEGIN_SRC json :tangle ../rsrc-schema/tst/vnd.eci.stg.order-ack.1.5.0-request.json
{}
#+END_SRC

**** XML
#+BEGIN_SRC xml :tangle ../rsrc-schema/tst/vnd.eci.stg.order-ack.1.5.0-request.xml
...
**** JSON
#+BEGIN_SRC json :tangle ../rsrc-schema/tst/vnd.eci.stg.order-ack.1.5.0-response.json
{}
#+END_SRC

**** XML
#+BEGIN_SRC xml :tangle ../rsrc-schema/tst/vnd.eci.stg.order-ack.1.5.0-response.xml
<?xml version='1.0' encoding='utf-8'?>
<order-ack/>
#+END_SRC
...
#+BEGIN_SRC json :tangle ../rsrc-schema/src/vnd.eci.stg.order-ack.1.5.0.json
  {
...
#+BEGIN_SRC xml :tangle ../rsrc-schema/src/vnd.eci.stg.order-ack.1.5.0.xsd
  <?xml version='1.0' encoding='utf-8'?>
