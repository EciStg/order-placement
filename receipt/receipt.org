...
**** POST single receipt
#+begin_src json :tangle ../rsrc-schema/tst/vnd.eci.stg.receipt.1.5.0-many-shipments-one-document.json
  { "reference": { "referencesCount": 2,
                   "references": [ { "code": "PO-ABC123-2",
                                     "type": "buyer" },
                                   { "code": "PO-XYZ-a",
...
#+begin_src json :tangle ../rsrc-schema/tst/vnd.eci.stg.receipt.1.5.0-many-shipments-many-receipts-1.json
  { "reference": { "referencesCount": 2,
                   "references": [{ "code": "PO-ABC123-2",
                                    "type": "buyer" },
                                  { "code": "PO-XYZ-a",
...
#+begin_src json :tangle ../rsrc-schema/tst/vnd.eci.stg.receipt.1.5.0-many-shipments-many-receipts-2.json
  { "reference": { "referencesCount": 2,
                   "references": [ { "code": "PO-ABC123-2",
                                     "type": "buyer" },
                                   { "code": "PO-XYZ-a",
