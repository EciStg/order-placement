...
**** One Order, One Shipment, One Receipt, No Order Items

***** JSON

#+begin_src json :tangle ../rsrc-schema/tst/vnd.eci.stg.receipt.1.5.0-one-order-one-shipment-one-receipt-no-items.json
  { "reference": { "referencesCount": 2,
                   "references": [{ "code": "PO-ABC123-2",
                                    "type": "buyer" }]},
    "shippingMethod": { "code": "shipper-123",
...
#+begin_src xml :tangle ../rsrc-schema/tst/vnd.eci.stg.receipt.1.5.0-one-order-one-shipment-one-receipt-no-items.xml
  <receipt>
    <reference>
      <referencesCount>2</referencesCount>
      <references>
...
**** One Order, One Shipmment, One Receipt
...
**** One Order, Many Shipments, One Receipt, No Order Items

#+begin_src json :tangle ../rsrc-schema/tst/vnd.eci.stg.receipt.1.5.0-one-order-many-shipments-one-receipt-no-items.json
  { "reference": { "referencesCount": 2,
                   "references": [{ "code": "PO-ABC123-2",
                                    "type": "buyer" }]},
    "itemsCount": 2,
...
**** One Order, Many Shipments, One Receipt

***** JSON

#+begin_src json :tangle ../rsrc-schema/tst/vnd.eci.stg.receipt.1.5.0-one-order-many-shipments-one-receipt.json
  { "reference": { "referencesCount": 2,
                   "references": [ { "code": "PO-ABC123-2",
                                     "type": "buyer" }]},
...
**** One Order, Many Shipments, Many Receipts
...
**** Many Orders, One Shipment, One Receipt, No Order Items

***** JSON

#+begin_src json :tangle ../rsrc-schema/tst/vnd.eci.stg.receipt.1.5.0-many-orders-one-shipment-one-receipt-no-items.json
  { "reference": { "referencesCount": 2,
                   "references": [{ "code": "PO-ABC123-2",
                                    "type": "buyer" },
                                  { "code": "PO-XYZ",
...
**** Many Orders, One Shipment, One Receipt
