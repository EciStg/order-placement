...
**** Sellers may respond with multiple locations.

In this example the vendor is not dipslaying the address, only showing a name of a location

***** JSON

#+BEGIN_SRC json :tangle ../rsrc-schema/tst/vnd.eci.stg.stock.1.5.0-quantity-response-multiple-warehouse.json
  { "itemsCount": 2,
    "items": [{ "reference": { "code": "abc-123",
                               "type": "seller" },
...
#+BEGIN_SRC xml :tangle ../rsrc-schema/tst/vnd.eci.stg.stock.1.5.0-quantity-response-multiple-warehouse.xml
  <?xml version='1.0' encoding='utf-8'?>
